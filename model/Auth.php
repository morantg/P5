...
class Auth
{
   ...
   * @return void
   */
    public function changerPermission($db, $permission, $user_id)
    {
    ...
    public function resetPassword($mysql_db, $email)
    {
        ...
        if ($user) {
            ...
            mail(
              ...
              \n\nhttp://projet5.local/index.php?action=auth.resetPassword&id={$user->id}&token=$reset_token"
            );
            return $user;
        }
        return false;
